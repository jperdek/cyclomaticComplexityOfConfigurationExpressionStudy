...
firstFormData <<- read.csv('../forms/fullFeatureTreeExpressions/nativeExpressions/generalAGGREGATETYPHONE_CYCLFORMFULLEXPR1.csv', sep=";")
secondFormData <<- read.csv('../forms/fullFeatureTreeExpressions/entireJSONExpressions/generalAGGREGATETYPHONE_CYCLFORMFULLEXPR2.csv', sep=";")
thirdFormData <<- read.csv('../forms/fullFeatureTreeExpressions/layeredJSONExpressions/generalAGGREGATETYPHONE_CYCLFORMFULLEXPR3.csv', sep=";")
fourthFormData <<- read.csv('../forms/fullFeatureTreeExpressions/customJSONExpressions/generalAGGREGATETYPHONE_CYCLFORMFULLEXPR4.csv', sep=";")

firstFormData <- filter(firstFormData, Overall.file.decorastors.2 > 0)
secondFormData <- filter(secondFormData, Overall.file.decorastors.2 > 0)
thirdFormData <- filter(thirdFormData, Overall.file.decorastors.2 > 0)
fourthFormData <- filter(fourthFormData, Overall.file.decorastors.2 > 0)
...
write.table(finalWilcoxTest, ".\\fileAnalysis\\pairedTestForm1-2.csv", row.names=FALSE, dec=",", sep=";")
